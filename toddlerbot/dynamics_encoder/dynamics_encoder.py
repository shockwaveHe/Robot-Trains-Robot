...
from toddlerbot.dynamics_encoder.network import EncoderDecoder
...
class Encoder(BaseSystem):
    def __init__(self, cfg):
        ...
        self.model_cfg = cfg.model if hasattr(cfg, "model") else cfg.autoencoder

        time_str = (
            cfg.data.time_str
            if hasattr(cfg.data, "time_str")
            else cfg.data.params_time_str
        )
