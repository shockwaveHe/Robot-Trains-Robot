...
from toddlerbot.dynamics_encoder.dynamics_encoder import Encoder
...
def main(cfg):
    ...
    datamodule = CombinedDataset(cfg.data)
    system = Encoder(cfg)
    ...
    if cfg.run_mode == "train":
        ...
        with open(os.path.join(output_dir, "summary.json"), "w") as f:
            json.dump(
                {
                    "transitions_time_str": cfg.data.transition_time_str,
                    "params_time_str": cfg.data.params_time_str,
                    "best_ckpt_path": best_ckpt_path,
                    "is_vae": cfg.autoencoder.is_vae,
                },
                f,
            )
